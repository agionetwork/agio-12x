...
import { Shield, Zap, CreditCard, Smartphone, Lock, Globe, Award, Users } from 'lucide-react'
...
const features = [
  ...
  },
  {
    ...
    description: 'Integração direta com carteiras Solana como Phantom.',
    color: 'from-indigo-500 to-purple-500'
  },
  {
    icon: Globe,
    title: 'Rede Solana',
    description: 'Transações rápidas e baratas na rede Solana.',
...
export default function Features() {
  return (
    <section className="py-16">
      ...
      >
        <div className="text-center">
          <div className="text-4xl font-bold text-blue-600 mb-2">R$ 2M+</div>
          <div className="text-gray-600">Volume processado</div>
        </div>
        <div className="text-center">
